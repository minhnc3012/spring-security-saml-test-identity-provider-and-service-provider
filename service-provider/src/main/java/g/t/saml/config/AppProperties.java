...
public class AppProperties extends SamlServerConfiguration {
	...
	public Map<String, String> getEntityIdToTargetIdMap() {
		return entityIdToTargetIdMap;
	}
	public void setEntityIdToTargetIdMap(Map<String, String> entityIdToTargetIdMap) {
		this.entityIdToTargetIdMap = entityIdToTargetIdMap;
	}
